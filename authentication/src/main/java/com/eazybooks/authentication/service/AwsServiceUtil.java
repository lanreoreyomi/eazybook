...
public class AwsServiceUtil {
  ...
  private final Logger logger = LoggerFactory.getLogger(AwsServiceUtil.class);
  ...
  public String composeUri(String hostAddress, String port) {
    return String.format("http://%s:%s/user/create-account", hostAddress, port);
  }
